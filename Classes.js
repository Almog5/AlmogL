...
class MainApp {
    ...
    Render() {
        ...
        if (this.filtered.length == 0) {
            alert("no matches found for you");
        ...
        else if (this.counter == this.filtered.length) {
        ...
        //</div>`;
            ...
            str3 += "<span><input type='button' id='like' value='like' onclick='moove()'/>";
            str3 += "<input type='button' id='Next' value='Next' onclick='moove()'/></span>";
            str3 += "</div>";
            return str3;
            //document.getElementById("Page1-Copy.html{Main}").innerHTML = str3;
        }
            //return this.filtered[this.counter].Render() ;
    }
